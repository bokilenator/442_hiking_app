//
//  TrailDetailsViewModelTests.swift
//  outbackTests
//
...
class TrailDetailsViewModelTests: XCTestCase {
  var park: Park!
  var trail: Trail!
  ...
  override func setUp() {
    ...
    viewModel = TrailDetailsViewModel(trail: trail)
  }
  ...
  func test_mapViewModel() {
    let mvm = viewModel.mapViewModel()
    XCTAssertEqual(trail.name, mvm.trail.name)
  }
